...
export default function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const finalImage = formData.image.trim() || 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=2070&auto=format&fit=crop';
    ...
    <div className="min-h-screen bg-[#09090b] text-white font-sans selection:bg-purple-500 selection:text-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
            ...
            <div className="flex flex-col">
              <span className="text-base md:text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 group-hover:to-white transition-all">
                SMP Terpadu
              </span>
              <span className="text-[9px] md:text-[10px] font-medium text-gray-500 tracking-[0.2em] uppercase -mt-0.5 group-hover:text-purple-400 transition-colors">
                Al-Ittihadiyah
              </span>
            </div>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-[#09090b]/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 md:hidden animate-fade-in p-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-400 text-sm">Akses cepat ke fitur showcase</p>
          </div>
          ...
          <button onClick={() => setMobileMenuOpen(false)} className="text-gray-500 hover:text-white mt-4 text-sm">
            Tutup Menu
          </button>
        </div>
      )}
      ...
      <section className="pt-32 md:pt-44 pb-12 md:pb-16 px-4 md:px-6 max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter mb-4 md:mb-6 leading-[1.15] md:leading-tight">
          Karya <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400">Siswa/i</span>, <br /> 
          Masa Depan Kalian.
        </h1>
        
        <p className="text-gray-400 text-base md:text-xl max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed px-2">
          Selamat datang di platform galeri digital SMP Terpadu Al-Ittihadiyah. 
          Tempat kami merayakan kreativitas, inovasi teknologi, dan bakat seni 
          dari seluruh siswa.
        </p>
        ...
        <form onSubmit={handleSearchSubmit} className="relative w-full max-w-xl mx-auto mb-6 md:mb-8 group px-2">
          ...
          <button 
            type="submit"
            className="absolute right-4 top-1/2 -translate-y-1/2 p-1.5 bg-white/10 hover:bg-purple-500 rounded-lg text-gray-400 hover:text-white transition-all"
            title="Cari"
          >
            <ArrowRight size={18} />
          </button>
      ...
      <section id="gallery-section" className="px-4 md:px-6 pb-24 max-w-7xl mx-auto flex-grow w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {filteredProjects.map((p) => (
            <div key={p.id} className="group relative bg-[#18181b]/60 backdrop-blur-md border border-white/5 rounded-2xl md:rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 hover:border-purple-500/20">
              ...
              <div className="p-5 md:p-6">
                ...
                <a href={p.driveLink} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-2 py-2.5 md:py-3 rounded-xl bg-white/5 border border-white/10 text-white font-medium text-xs md:text-sm hover:bg-white hover:text-black transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Platform showcase karya digital siswa untuk menginspirasi dan berinovasi di era teknologi.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li>
                  <a href="https://wa.me/62895351251395" target="_blank" rel="noreferrer" className="flex items-start gap-3 text-gray-400 hover:text-green-400 transition-colors group">
                    <Phone size={18} className="mt-1 group-hover:scale-110 transition-transform"/>
                    <span className="text-sm">+62 895 3512 51395 <br/><span className="text-xs opacity-60">(WhatsApp Admin)</span></span>
                  </a>
                </li>
                <li>
                  <a href="https://maps.google.com/?q=SMP+Terpadu+Al-Ittihadiyah+Ciampea+Bogor+jawa+barat+Indonesia" target="_blank" rel="noreferrer" className="flex items-start gap-3 text-gray-400 hover:text-blue-400 transition-colors group">
                    <MapPin size={18} className="mt-1 group-hover:scale-110 transition-transform"/>
                    <span className="text-sm">Kp Pasar Salasa, Desa Ciampea Udik, Bogor, Jawa Barat.</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://github.com/dafbeatx" target="_blank" rel="noreferrer" className="h-10 w-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-white hover:text-black transition-all hover:-translate-y-1">
                  <Github size={18} />
                </a>
                <a href="https://youtube.com/@smpterpadualittihadiyahbogor?si=ZREUlBQW8hNF9ja1" target="_blank" rel="noreferrer" className="h-10 w-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all hover:-translate-y-1">
                  <Youtube size={18} />
                </a>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-2">
                <div className="flex items-center gap-2 text-xs text-gray-400">
                  <Copyright size={12}/> <span>MIT License</span>
                </div>
                <p className="text-xs text-gray-500">
                  Website ini open-source. Dibuat dengan <Heart size={10} className="inline text-red-500"/> oleh Dafa Maulana, S.Pd selaku Guru Informatika.
                </p>
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm text-center md:text-left">
              © 2025 SMP Terpadu Al-Ittihadiyah. All rights reserved.
            </p>
        ...
        <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center px-0 md:px-4 bg-black/80 backdrop-blur-sm animate-fade-in">
          ...
          <div className="w-full max-w-2xl bg-[#121214] border-t md:border border-white/10 rounded-t-3xl md:rounded-3xl p-6 md:p-8 h-[85vh] md:max-h-[90vh] overflow-y-auto relative shadow-2xl shadow-purple-900/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pb-10 md:pb-0">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                 <input name="image" value={formData.image} onChange={handleInputChange} placeholder="Link Gambar Cover (Opsional)" className="w-full bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-purple-500 outline-none text-xs md:text-sm"/>
