...
export default function NewsCard({ post }: NewsCardProps) {
    ...
    return (
        <div className="group bg-[#18181b]/60 backdrop-blur-md border border-white/5 rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 hover:border-purple-500/20 flex flex-col h-full">
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <h3 className="text-xl font-bold mb-3 group-hover:text-purple-300 transition-colors line-clamp-2 leading-tight">
                    {title}
                </h3>
                ...
                <Link
                    href={`/news/${id}`}
                    className="mt-auto inline-flex items-center gap-2 text-sm font-bold text-white group/link"
                >
                    Baca Selengkapnya
