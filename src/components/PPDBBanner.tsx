...
export default function PPDBBanner() {
    return (
        <section className="max-w-7xl mx-auto px-4 md:px-6 mb-12 md:mb-24 animate-fade-in-up">
            <div className="relative overflow-hidden rounded-[32px] md:rounded-[40px] bg-gradient-to-br from-emerald-600 via-green-600 to-teal-600 p-1 md:p-1.5 shadow-2xl shadow-emerald-500/20">
                <div className="relative bg-[var(--background)] rounded-[28px] md:rounded-[36px] overflow-hidden p-6 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                    ...
                    <div className="relative flex-grow space-y-4 md:space-y-6 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
                        ...
                        <h2 className="text-2xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.2] md:leading-[1.1]">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500">Dari Sini.</span>
                        </h2>
                        ...
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2 md:pt-4">
                            <a
                                ...
                                className="px-8 py-4 md:px-10 md:py-5 bg-[var(--accent)] text-white font-black text-base md:text-lg rounded-2xl hover:opacity-90 flex items-center gap-2 md:gap-3 transition-all active:scale-[0.98] shadow-xl shadow-emerald-500/30 uppercase tracking-widest"
                            >
                    ...
                    <div className="relative w-full lg:w-[400px] h-48 md:h-64 lg:h-80 flex-shrink-0 animate-float">
                        <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/30 to-green-500/30 rounded-[32px] md:rounded-[40px] rotate-6 scale-95 blur-xl" />
                        <div className="relative w-full h-full bg-[var(--card-bg)] border border-[var(--border)] rounded-[32px] md:rounded-[40px] overflow-hidden shadow-2xl group">
                            ...
                            <div className="absolute bottom-4 md:bottom-6 left-6 right-6">
                                <div className="h-1 w-full bg-white/20 rounded-full overflow-hidden">
                                    <div className="h-full w-2/3 bg-gradient-to-r from-emerald-400 to-green-400 rounded-full animate-pulse" />
                                </div>
